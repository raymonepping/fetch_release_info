# Vault Enterprise — Release Update
...
- Credential rotation: Vault Agent backoff reduces aggressive retries during secret rotation so that agents create less unnecessary network traffic and server load.
...
- 2.0.0 - Yes - All - Previously unauthenticated endpoints require authentication
...
- 2.0.0 - Yes - Enterprise - DR secondaries now accept root tokens from the primary
- 2.0.0 - Yes - Enterprise - Okta SCIM group membership removal does not revoke Vault group access
- 2.0.0 - Yes - Enterprise - Root token KV access blocked by EGP policy
- 2.0.0 - No - All - Sidebar menu reloads on engine-scoped pages
- 2.0.0 - Yes - All - Secrets Engines items-per-page change can hide results
- 2.0.0 - Yes - Enterprise - LDAP secrets self-managed static roles feature does not work with the openldap built-in type alias

---
_Source: [Release Notes](https://developer.hashicorp.com/vault/docs/updates/release-notes) · [Change Tracker](https://developer.hashicorp.com/vault/docs/updates/change-tracker)_
